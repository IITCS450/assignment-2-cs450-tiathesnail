...
_testprio:     file format elf32-i386
...
int main(void){
   ...
   e:	51                   	push   %ecx
  int me = getpid();
   f:	e8 6f 03 00 00       	call   383 <getpid>
  int r;
  ...
  r = setpriority(me, 1);
  1b:	50                   	push   %eax
  1c:	e8 82 03 00 00       	call   3a3 <setpriority>
  check("setpriority(self,1) returns 0", r == 0);
  21:	31 d2                	xor    %edx,%edx
  23:	85 c0                	test   %eax,%eax
  25:	b8 9c 07 00 00       	mov    $0x79c,%eax
  2a:	0f 94 c2             	sete   %dl
  2d:	e8 4e 00 00 00       	call   80 <check>
  ...
  38:	e8 66 03 00 00       	call   3a3 <setpriority>
  check("setpriority(-1,1) returns -1", r == -1);
  3d:	31 d2                	xor    %edx,%edx
  3f:	83 f8 ff             	cmp    $0xffffffff,%eax
  42:	b8 ba 07 00 00       	mov    $0x7ba,%eax
  47:	0f 94 c2             	sete   %dl
  4a:	e8 31 00 00 00       	call   80 <check>
  ...
  51:	6a 63                	push   $0x63
  53:	53                   	push   %ebx
  54:	e8 4a 03 00 00       	call   3a3 <setpriority>
  check("setpriority(self,99) returns -1", r == -1);
  59:	31 d2                	xor    %edx,%edx
  5b:	83 f8 ff             	cmp    $0xffffffff,%eax
  5e:	b8 e8 07 00 00       	mov    $0x7e8,%eax
  63:	0f 94 c2             	sete   %dl
  66:	e8 15 00 00 00       	call   80 <check>

  printf(1, "testprio: done\n");
  6b:	58                   	pop    %eax
  6c:	5a                   	pop    %edx
  6d:	68 d7 07 00 00       	push   $0x7d7
  72:	6a 01                	push   $0x1
...
static void check(const char *msg, int cond) {
  ...
  88:	74 12                	je     9c <check+0x1c>
  8a:	83 ec 04             	sub    $0x4,%esp
  8d:	50                   	push   %eax
  8e:	68 88 07 00 00       	push   $0x788
  93:	6a 01                	push   $0x1
  ...
  9c:	52                   	push   %edx
  9d:	50                   	push   %eax
  9e:	68 92 07 00 00       	push   $0x792
  a3:	6a 01                	push   $0x1
  a5:	e8 b6 03 00 00       	call   460 <printf>
  aa:	e8 54 02 00 00       	call   303 <exit>
  af:	90                   	nop
