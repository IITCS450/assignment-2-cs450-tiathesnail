...
80103800:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103806:	e8 b5 0d 00 00       	call   801045c0 <release>
...
80103818:	74 5f                	je     80103879 <allocproc+0xc9>
    return 0;
  }
  ...
  sp -= sizeof *p->tf;
8010381a:	8d 90 b4 0f 00 00    	lea    0xfb4(%eax),%edx
  sp -= 4;
...
80103820:	83 ec 04             	sub    $0x4,%esp
  sp -= sizeof *p->context;
80103823:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *p->tf;
80103828:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010382b:	c7 40 14 2f 59 10 80 	movl   $0x8010592f,0x14(%eax)
  p->context = (struct context*)sp;
80103832:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103835:	6a 14                	push   $0x14
80103837:	6a 00                	push   $0x0
80103839:	50                   	push   %eax
8010383a:	e8 a1 0e 00 00       	call   801046e0 <memset>
  p->context->eip = (uint)forkret;
8010383f:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80103842:	83 c4 10             	add    $0x10,%esp
  p->context->eip = (uint)forkret;
80103845:	c7 40 10 90 38 10 80 	movl   $0x80103890,0x10(%eax)
}
8010384c:	89 d8                	mov    %ebx,%eax
  p->priority = 1;
8010384e:	c7 43 7c 01 00 00 00 	movl   $0x1,0x7c(%ebx)
}
...
8010386a:	e8 51 0d 00 00       	call   801045c0 <release>
}
...
8010389b:	e8 20 0d 00 00       	call   801045c0 <release>
...
801038e6:	68 c0 77 10 80       	push   $0x801077c0
801038eb:	68 20 1d 11 80       	push   $0x80111d20
801038f0:	e8 5b 0b 00 00       	call   80104450 <initlock>
}
...
80103984:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103987:	e8 44 0b 00 00       	call   801044d0 <pushcli>
  c = mycpu();
8010398c:	e8 6f ff ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103991:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103997:	e8 84 0b 00 00       	call   80104520 <popcli>
}
...
801039c3:	e8 58 35 00 00       	call   80106f20 <setupkvm>
...
801039e1:	e8 ea 31 00 00       	call   80106bd0 <inituvm>
...
801039f6:	e8 e5 0c 00 00       	call   801046e0 <memset>
...
80103a4f:	68 f0 77 10 80       	push   $0x801077f0
80103a54:	50                   	push   %eax
80103a55:	e8 46 0e 00 00       	call   801048a0 <safestrcpy>
  p->cwd = namei("/");
80103a5a:	c7 04 24 f9 77 10 80 	movl   $0x801077f9,(%esp)
...
80103a93:	68 d7 77 10 80       	push   $0x801077d7
...
80103aa5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103aa8:	e8 23 0a 00 00       	call   801044d0 <pushcli>
  c = mycpu();
80103aad:	e8 4e fe ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103ab2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ab8:	e8 63 0a 00 00       	call   80104520 <popcli>
  sz = curproc->sz;
...
80103acb:	e8 f0 2f 00 00       	call   80106ac0 <switchuvm>
  return 0;
...
80103aea:	e8 51 32 00 00       	call   80106d40 <allocuvm>
...
80103b0a:	e8 61 33 00 00       	call   80106e70 <deallocuvm>
...
80103bb9:	e8 92 db ff ff       	call   80101750 <idup>
80103bbe:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103bc1:	83 c4 0c             	add    $0xc,%esp
  np->cwd = idup(curproc->cwd);
80103bc4:	89 47 68             	mov    %eax,0x68(%edi)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103bc7:	8d 43 6c             	lea    0x6c(%ebx),%eax
80103bca:	6a 10                	push   $0x10
80103bcc:	50                   	push   %eax
80103bcd:	8d 47 6c             	lea    0x6c(%edi),%eax
80103bd0:	50                   	push   %eax
80103bd1:	e8 ca 0c 00 00       	call   801048a0 <safestrcpy>
  pid = np->pid;
80103bd6:	8b 77 10             	mov    0x10(%edi),%esi
  acquire(&ptable.lock);
80103bd9:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103be0:	e8 3b 0a 00 00       	call   80104620 <acquire>
  np->state = RUNNABLE;
80103be5:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  np->priority = curproc->priority;
80103bec:	8b 43 7c             	mov    0x7c(%ebx),%eax
80103bef:	89 47 7c             	mov    %eax,0x7c(%edi)
  release(&ptable.lock);
80103bf2:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103bf9:	e8 c2 09 00 00       	call   801045c0 <release>
  return pid;
80103bfe:	83 c4 10             	add    $0x10,%esp
}
80103c01:	8d 65 f4             	lea    -0xc(%ebp),%esp
80103c04:	89 f0                	mov    %esi,%eax
80103c06:	5b                   	pop    %ebx
80103c07:	5e                   	pop    %esi
80103c08:	5f                   	pop    %edi
80103c09:	5d                   	pop    %ebp
80103c0a:	c3                   	ret    
    return -1;
80103c0b:	be ff ff ff ff       	mov    $0xffffffff,%esi
80103c10:	eb ef                	jmp    80103c01 <fork+0xe1>
    kfree(np->kstack);
80103c12:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80103c15:	83 ec 0c             	sub    $0xc,%esp
    return -1;
80103c18:	be ff ff ff ff       	mov    $0xffffffff,%esi
    kfree(np->kstack);
80103c1d:	ff 73 08             	pushl  0x8(%ebx)
80103c20:	e8 9b e8 ff ff       	call   801024c0 <kfree>
    np->kstack = 0;
80103c25:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    return -1;
80103c2c:	83 c4 10             	add    $0x10,%esp
    np->state = UNUSED;
80103c2f:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return -1;
80103c36:	eb c9                	jmp    80103c01 <fork+0xe1>
...
80103c6e:	e8 ad 09 00 00       	call   80104620 <acquire>
...
80103c90:	e8 2b 2e 00 00       	call   80106ac0 <switchuvm>
...
80103c9b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103ca2:	e8 54 0c 00 00       	call   801048fb <swtch>
      switchkvm();
80103ca7:	e8 04 2e 00 00       	call   80106ab0 <switchkvm>
      c->proc = 0;
...
80103ccc:	e8 ef 08 00 00       	call   801045c0 <release>
    sti();
...
80103d43:	e8 b3 0b 00 00       	call   801048fb <swtch>
  mycpu()->intena = intena;
...
80103e0a:	e8 11 08 00 00       	call   80104620 <acquire>
...
80103ead:	68 48 78 10 80       	push   $0x80107848
80103eb2:	e8 c9 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103eb7:	83 ec 0c             	sub    $0xc,%esp
80103eba:	68 3b 78 10 80       	push   $0x8010783b
...
80103f3b:	0f 85 95 00 00 00    	jne    80103fd6 <wait+0x106>
  pushcli();
80103f41:	e8 8a 05 00 00       	call   801044d0 <pushcli>
  c = mycpu();
80103f46:	e8 b5 f9 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103f4b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f51:	e8 ca 05 00 00       	call   80104520 <popcli>
  if(p == 0)
...
80103f99:	e8 02 2f 00 00       	call   80106ea0 <freevm>
        p->pid = 0;
...
80103fc5:	e8 f6 05 00 00       	call   801045c0 <release>
        return pid;
...
8010400c:	e8 0f 06 00 00       	call   80104620 <acquire>
  pushcli();
80104011:	e8 ba 04 00 00       	call   801044d0 <pushcli>
  c = mycpu();
80104016:	e8 e5 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010401b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104021:	e8 fa 04 00 00       	call   80104520 <popcli>
...
80104039:	e8 82 05 00 00       	call   801045c0 <release>
}
...
8010405c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010405f:	e8 6c 04 00 00       	call   801044d0 <pushcli>
  c = mycpu();
80104064:	e8 97 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104069:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010406f:	e8 ac 04 00 00       	call   80104520 <popcli>
  if(p == 0)
...
80104090:	e8 8b 05 00 00       	call   80104620 <acquire>
    release(lk);
80104095:	89 34 24             	mov    %esi,(%esp)
80104098:	e8 23 05 00 00       	call   801045c0 <release>
  p->chan = chan;
...
801040ba:	e8 01 05 00 00       	call   801045c0 <release>
    acquire(lk);
...
801040cb:	5d                   	pop    %ebp
    acquire(lk);
801040cc:	e9 4f 05 00 00       	jmp    80104620 <acquire>
...
801040f9:	68 5a 78 10 80       	push   $0x8010785a
801040fe:	e8 7d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104103:	83 ec 0c             	sub    $0xc,%esp
80104106:	68 54 78 10 80       	push   $0x80107854
...
80104160:	c9                   	leave  
  release(&ptable.lock);
80104161:	e9 5a 04 00 00       	jmp    801045c0 <release>
...
801041bb:	e8 00 04 00 00       	call   801045c0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041d8:	e8 e3 03 00 00       	call   801045c0 <release>
}
...
8010420b:	68 db 7b 10 80       	push   $0x80107bdb
...
8010422c:	74 ea                	je     80104218 <procdump+0x28>
      state = "???";
8010422e:	ba 6b 78 10 80       	mov    $0x8010786b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104233:	83 f8 05             	cmp    $0x5,%eax
80104236:	77 11                	ja     80104249 <procdump+0x59>
80104238:	8b 14 85 cc 78 10 80 	mov    -0x7fef8734(,%eax,4),%edx
      state = "???";
8010423f:	b8 6b 78 10 80       	mov    $0x8010786b,%eax
...
8010424e:	68 6f 78 10 80       	push   $0x8010786f
...
80104275:	e8 f6 01 00 00       	call   80104470 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
8010428d:	68 c1 72 10 80       	push   $0x801072c1
...
801042bf:	e8 5c 03 00 00       	call   80104620 <acquire>
801042c4:	83 c4 10             	add    $0x10,%esp
 for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042c7:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
801042cc:	eb 0c                	jmp    801042da <setpriority+0x2a>
801042ce:	66 90                	xchg   %ax,%ax
801042d0:	83 e8 80             	sub    $0xffffff80,%eax
801042d3:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
801042d8:	74 26                	je     80104300 <setpriority+0x50>
  if(p->pid == pid){
801042da:	39 58 10             	cmp    %ebx,0x10(%eax)
801042dd:	75 f1                	jne    801042d0 <setpriority+0x20>
   p->priority = prio;
801042df:	8b 55 0c             	mov    0xc(%ebp),%edx
   release(&ptable.lock);
801042e2:	83 ec 0c             	sub    $0xc,%esp
   p->priority = prio;
801042e5:	89 50 7c             	mov    %edx,0x7c(%eax)
   release(&ptable.lock);
801042e8:	68 20 1d 11 80       	push   $0x80111d20
801042ed:	e8 ce 02 00 00       	call   801045c0 <release>
   return 0;
  }
 }
release(&ptable.lock);
...
80104308:	e8 b3 02 00 00       	call   801045c0 <release>
}
...
8010432a:	68 e4 78 10 80       	push   $0x801078e4
...
80104385:	e8 c6 fc ff ff       	call   80104050 <sleep>
  while (lk->locked) {
...
80104393:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104399:	e8 e2 f5 ff ff       	call   80103980 <myproc>
...
801043e4:	e8 27 fd ff ff       	call   80104110 <wakeup>
  release(&lk->lk);
...
8010443b:	e8 40 f5 ff ff       	call   80103980 <myproc>
...
801044d9:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
801044da:	e8 21 f4 ff ff       	call   80103900 <mycpu>
...
80104565:	68 ef 78 10 80       	push   $0x801078ef
8010456a:	e8 11 be ff ff       	call   80100380 <panic>
    panic("popcli");
8010456f:	83 ec 0c             	sub    $0xc,%esp
80104572:	68 06 79 10 80       	push   $0x80107906
...
801045a3:	e8 58 f3 ff ff       	call   80103900 <mycpu>
...
8010465c:	e8 9f f2 ff ff       	call   80103900 <mycpu>
...
801046bb:	e8 40 f2 ff ff       	call   80103900 <mycpu>
...
801046d0:	68 15 79 10 80       	push   $0x80107915
...
80104917:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010491a:	e8 61 f0 ff ff       	call   80103980 <myproc>
...
80104957:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010495a:	e8 21 f0 ff ff       	call   80103980 <myproc>
...
801049a5:	e8 d6 ef ff ff       	call   80103980 <myproc>
...
801049b3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801049b6:	e8 c5 ef ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
801049fe:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104a00:	e8 7b ef ff ff       	call   80103980 <myproc>
...
80104a0e:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a11:	e8 6a ef ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104a64:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104a65:	e8 16 ef ff ff       	call   80103980 <myproc>
...
80104a73:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a76:	e8 05 ef ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104a8b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104a8e:	e8 ed ee ff ff       	call   80103980 <myproc>
  if(addr >= curproc->sz)
...
80104ae4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104ae7:	e8 94 ee ff ff       	call   80103980 <myproc>
...
80104af7:	83 fa 15             	cmp    $0x15,%edx
80104afa:	77 24                	ja     80104b20 <syscall+0x40>
80104afc:	8b 14 85 40 79 10 80 	mov    -0x7fef86c0(,%eax,4),%edx
...
80104b28:	68 1d 79 10 80       	push   $0x8010791d
...
80104c84:	68 b8 79 10 80       	push   $0x801079b8
...
80104c9c:	68 b7 79 10 80       	push   $0x801079b7
...
80104cb1:	68 ab 79 10 80       	push   $0x801079ab
...
80104ccf:	68 ba 79 10 80       	push   $0x801079ba
80104cd4:	e8 a7 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104cd9:	83 ec 0c             	sub    $0xc,%esp
80104cdc:	68 9c 79 10 80       	push   $0x8010799c
...
801050dd:	58                   	pop    %eax
801050de:	5a                   	pop    %edx
801050df:	68 b8 79 10 80       	push   $0x801079b8
...
801050f8:	68 b7 79 10 80       	push   $0x801079b7
...
801051f3:	ff 75 b4             	pushl  -0x4c(%ebp)
...
8010561f:	ff b5 5c ff ff ff    	pushl  -0xa4(%ebp)
...
801058d6:	78 38                	js     80105910 <sys_setpriority+0x50>
	return -1;
}
if(argint(1,&prio) <0){
...
801058eb:	78 23                	js     80105910 <sys_setpriority+0x50>
	return -1;
}
if(prio < 0 || prio > 2){
801058ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058f0:	83 f8 02             	cmp    $0x2,%eax
801058f3:	77 1b                	ja     80105910 <sys_setpriority+0x50>
	return -1;
}
...
801058f9:	ff 75 f0             	pushl  -0x10(%ebp)
801058fc:	e8 af e9 ff ff       	call   801042b0 <setpriority>
...
80105957:	c7 04 c5 c2 3d 11 80 	movl   $0x8e000008,-0x7feec23e(,%eax,8)
8010595e:	08 00 00 8e 
80105962:	66 89 14 c5 c0 3d 11 	mov    %dx,-0x7feec240(,%eax,8)
80105969:	80 
8010596a:	c1 ea 10             	shr    $0x10,%edx
8010596d:	66 89 14 c5 c6 3d 11 	mov    %dx,-0x7feec23a(,%eax,8)
80105974:	80 
  for(i = 0; i < 256; i++)
...
80105987:	c7 05 c2 3f 11 80 08 	movl   $0xef000008,0x80113fc2
8010598e:	00 00 ef 
  initlock(&tickslock, "time");
80105991:	68 fd 79 10 80       	push   $0x801079fd
80105996:	68 80 3d 11 80       	push   $0x80113d80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010599b:	66 a3 c0 3f 11 80    	mov    %ax,0x80113fc0
801059a1:	c1 e8 10             	shr    $0x10,%eax
801059a4:	66 a3 c6 3f 11 80    	mov    %ax,0x80113fc6
  initlock(&tickslock, "time");
...
801059cb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801059cf:	b8 c0 3d 11 80       	mov    $0x80113dc0,%eax
...
80105a50:	e8 2b df ff ff       	call   80103980 <myproc>
80105a55:	85 c0                	test   %eax,%eax
80105a57:	74 0f                	je     80105a68 <trap+0x78>
80105a59:	e8 22 df ff ff       	call   80103980 <myproc>
...
80105a62:	0f 84 b8 00 00 00    	je     80105b20 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a68:	e8 13 df ff ff       	call   80103980 <myproc>
...
80105ac0:	e8 9b de ff ff       	call   80103960 <cpuid>
...
80105ae7:	ff 75 e4             	pushl  -0x1c(%ebp)
...
80105b02:	e8 79 de ff ff       	call   80103980 <myproc>
80105b07:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b0e:	e8 6d de ff ff       	call   80103980 <myproc>
...
80105b24:	0f 85 3e ff ff ff    	jne    80105a68 <trap+0x78>
    yield();
80105b2a:	e8 d1 e4 ff ff       	call   80104000 <yield>
...
80105b3f:	e8 1c de ff ff       	call   80103960 <cpuid>
...
80105b56:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b59:	e8 22 de ff ff       	call   80103980 <myproc>
...
80105b7a:	0f 85 c8 00 00 00    	jne    80105c48 <trap+0x258>
    myproc()->tf = tf;
80105b80:	e8 fb dd ff ff       	call   80103980 <myproc>
80105b85:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105b88:	e8 53 ef ff ff       	call   80104ae0 <syscall>
    if(myproc()->killed)
...
80105ba3:	5d                   	pop    %ebp
      exit();
80105ba4:	e9 f7 e1 ff ff       	jmp    80103da0 <exit>
...
80105bd5:	e8 36 cd ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105bda:	e8 a1 dd ff ff       	call   80103980 <myproc>
...
80105bec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105bf0:	e8 6b dd ff ff       	call   80103960 <cpuid>
80105bf5:	85 c0                	test   %eax,%eax
80105bf7:	0f 85 28 fe ff ff    	jne    80105a25 <trap+0x35>
      acquire(&tickslock);
80105bfd:	83 ec 0c             	sub    $0xc,%esp
80105c00:	68 80 3d 11 80       	push   $0x80113d80
80105c05:	e8 16 ea ff ff       	call   80104620 <acquire>
      wakeup(&ticks);
80105c0a:	c7 04 24 60 3d 11 80 	movl   $0x80113d60,(%esp)
      ticks++;
80105c11:	83 05 60 3d 11 80 01 	addl   $0x1,0x80113d60
      wakeup(&ticks);
80105c18:	e8 f3 e4 ff ff       	call   80104110 <wakeup>
      release(&tickslock);
80105c1d:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
80105c24:	e8 97 e9 ff ff       	call   801045c0 <release>
...
{
  if(!uart)
80105c80:	a1 c0 45 11 80       	mov    0x801145c0,%eax
...
80105d07:	74 78                	je     80105d81 <uartinit+0xd1>
  uart = 1;
80105d09:	c7 05 c0 45 11 80 01 	movl   $0x1,0x801145c0
80105d10:	00 00 00 
...
80105d90 <uartputc>:
  if(!uart)
80105d90:	a1 c0 45 11 80       	mov    0x801145c0,%eax
...
801069c5:	e8 16 dd ff ff       	call   801046e0 <memset>
...
80106a23:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106a26:	e8 35 cf ff ff       	call   80103960 <cpuid>
  pd[0] = size-1;
...
80106ab0:	a1 c4 45 11 80       	mov    0x801145c4,%eax
...
80106ae4:	0f 84 c2 00 00 00    	je     80106bac <switchuvm+0xec>
  pushcli();
80106aea:	e8 e1 d9 ff ff       	call   801044d0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106aef:	e8 0c ce ff ff       	call   80103900 <mycpu>
80106af4:	89 c3                	mov    %eax,%ebx
80106af6:	e8 05 ce ff ff       	call   80103900 <mycpu>
...
80106b08:	e8 f3 cd ff ff       	call   80103900 <mycpu>
...
80106b51:	e8 aa cd ff ff       	call   80103900 <mycpu>
...
80106b74:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106b77:	e8 84 cd ff ff       	call   80103900 <mycpu>
...
80106b99:	5d                   	pop    %ebp
  popcli();
80106b9a:	e9 81 d9 ff ff       	jmp    80104520 <popcli>
...
80106bff:	e8 dc da ff ff       	call   801046e0 <memset>
...
80106c32:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c33:	e9 48 db ff ff       	jmp    80104780 <memmove>
...
80106fab:	a3 c4 45 11 80       	mov    %eax,0x801145c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801070b0:	e8 cb d6 ff ff       	call   80104780 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
801070b5:	58                   	pop    %eax
801070b6:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801070bc:	5a                   	pop    %edx
801070bd:	ff 75 e4             	pushl  -0x1c(%ebp)
...
80107107:	ff 75 e0             	pushl  -0x20(%ebp)
...
801071e0:	e8 9b d5 ff ff       	call   80104780 <memmove>
    len -= n;
    buf += n;
